...
#   Version: 2
#
#   This is the code for a very simple chat prototype of a movie recommender. The primary enhancement
#   for this version is code that allows us to view the fields of our request body (the payload) and
#   to see the full content of the response from the server. As you ask questions the size of the
#   request body (payload) will grow. This gives the remote server all of the context of the chat so
#   it can respond knowing what conversation has happend before.
#   
...
API_KEY = "<GET_AN_API_KEY_AND_PUT_IT_HERE"
#
...
def make_chat_request(user_text="", chat_context=None, api_key=""):
    ...
    print()
    print("REQUEST BODY =================================")
    print(json.dumps(chat_context, indent=4))
    print("RESPONSE =====================================")
