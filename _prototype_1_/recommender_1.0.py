...
#   Version: 0
#
#   This is the code for a very simple chat prototype of a movie recommender. This example is
#   meant to be minimalistic to help you understand how a chat type AI system might work
#   
